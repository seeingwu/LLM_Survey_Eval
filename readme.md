...
**LLM_Survey_Eval** is an integrated evaluation framework designed to assess the realism, structure, and inferential validity of survey data generated by large language models (LLMs). It provides a four-tier system that compares LLM-simulated responses with real human survey data across descriptive, behavioural, multivariate, and inferential dimensions. The project bridges artificial intelligence and social science by offering transparent, reproducible metrics that quantify how closely LLMs replicate human reasoning and behaviour, supporting both academic research and practical policy analysis in urban and behavioural studies.
